...
Version tags (see `VERSION`): **v2.15.0** = `PENDINGSHA`,
...
| --- | --- | --- |
| 2026-08-10 | `PENDINGSHA` | **v2.15.0** — REALISM.md Phase 4 (AI): coverage no longer empties on every throw, defenders hold leverage and can undercut a route, and the quarterback works a progression under pressure — interceptions off zero and into the 3-5% the sport runs at |
