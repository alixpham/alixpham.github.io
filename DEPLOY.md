...
Version tags (see `VERSION`): **v2.4.0** = `PENDINGSHA`,
...
| --- | --- | --- |
| 2026-08-09 | `PENDINGSHA` | **v2.4.0** — athletic player build (square shoulders, real neck, thicker arms and calves) and a portrait camera pulled back off the carrier, with the lens clamped inside the bowl |
