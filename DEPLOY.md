...
Version tags (see `VERSION`): **v2.11.0** = `PENDINGSHA`,
...
| --- | --- | --- |
| 2026-08-09 | `PENDINGSHA` | **v2.11.0** — the ball is carried by the player instead of floating near them: tucked high and tight on the outside arm off the chest bone, and riding the throwing hand through a wind-up |
