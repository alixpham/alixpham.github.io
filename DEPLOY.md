...
Version tags (see `VERSION`): **v2.1.1** = `PENDING`,
...
| --- | --- | --- |
| 2026-08-08 | `PENDING` | **v2.1.1** — landing screen turned around: the cast now runs, cuts and throws toward the viewer, so you see faces and jersey fronts instead of three backs jogging away |
