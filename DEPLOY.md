...
Version tags (see `VERSION`): **v2.6.0** = `ce74b6ade303d467e4fcae17b7181080fb225e96`,
...
| --- | --- | --- |
| 2026-08-09 | `ce74b6ade303d467e4fcae17b7181080fb225e96` | **v2.6.0** — the running version is shown on the home screen, read from the VERSION file itself so it can't drift from what's deployed |
