...
Version tags (see `VERSION`): **v2.9.0** = `8f8b3a644583315bfb58f03b8423b58a6f9c9def`,
...
| --- | --- | --- |
| 2026-08-09 | `8f8b3a644583315bfb58f03b8423b58a6f9c9def` | **v2.9.0** — juke reworked (no more juke-lock, no cooldown burned on a whiff, a real sidestep), throws wind up so the ball leaves with the arm, and the CPU quarterback can finally pass at all |
