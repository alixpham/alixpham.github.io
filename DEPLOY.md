...
Version tags (see `VERSION`): **v2.7.0** = `PENDINGSHA`,
...
| --- | --- | --- |
| 2026-08-09 | `PENDINGSHA` | **v2.7.0** — nobody freezes any more: receivers work open after their route, the centre releases instead of standing still, and zone/man/spy coverage tracks live targets instead of parking on a fixed dot |
